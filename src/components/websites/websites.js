    ...
    <div>
      ...
      <section>
        <div className="pictur">
          <div className="punchbox2 text-white container">
            <h4 className="punchlines bottom-left veers">Websites</h4>

            <h5 className="sub-lines ">
              We are poised to help your enterprise
              <br /> gain the visibilty and engagements it needs
            </h5>
      ...
      <section>
        <div className="pictures5">
          <div className="punchbox2 text-white container  ">
            <h4 className="punchlines veer  mb-3">
              Nature At
              <br /> The Comfort <br />
              of Your Home
            </h4>
            ...
            <h5 className="sub-lines">
              We built visibililty for Green to <br />
              satisfy nature lovers
            </h5>
