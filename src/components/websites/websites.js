  ...
  const data = [
    {
      ...
      line3: "Websites are the heart of the internet, a creative website",
      line4: "sets the tone for the impactful branding and marketing of",
      line5: "your product and services",
      index: 4,
      sound: sound4,
